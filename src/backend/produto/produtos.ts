...
export async function obterProdutos(): Promise<Produto[]> {
  return [
    ...
    { id: 11, nome: "Camiseta Básica", preco: 49.9, imagemUrl: "/produto1.png" },
    ...
    { id: 14, nome: "Camiseta Oversized", preco: 59.9, imagemUrl: "/produto1.png" },
    { id: 15, nome: "Camiseta Oversized", preco: 59.9, imagemUrl: "/produto1.png" },
    { id: 16, nome: "Camiseta Oversized", preco: 59.9, imagemUrl: "/produto1.png" },
    { id: 17, nome: "Camiseta Oversized", preco: 59.9, imagemUrl: "/produto1.png" },
    { id: 18, nome: "Camiseta Oversized", preco: 59.9, imagemUrl: "/produto1.png" },
    { id: 19, nome: "Camiseta Oversized", preco: 59.9, imagemUrl: "/produto1.png" },
    { id: 20, nome: "Camiseta Oversized", preco: 59.9, imagemUrl: "/produto1.png" },
